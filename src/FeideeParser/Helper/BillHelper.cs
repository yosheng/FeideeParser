...
public class BillHelper
{
    ...
    public static byte[] GenerateExcelByte(FeideeBill exportTemplate)
    {
    ...
    private static void SetExcelValue(string transactionType, ISheet sheet, List<FeideeBillItem> data, ICellStyle style)
    {
